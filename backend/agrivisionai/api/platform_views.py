...
class PlatformOverviewView(APIView):
    ...
    def get(self, request):
        return Response(
            {
                "platform": "AgriVisionAI",
                "modules": ["authentication", "marketplace", "analytics", "transport"],
                "flows": [
                    "Users authenticate and manage profiles",
                    "Listings and bookings feed market operations",
                    "Weather and market history produce predictions",
                    "Transport requests coordinate providers and order movement",
                ],
...
class PlatformMarketplaceView(APIView):
    ...
    def get(self, request):
        recent_listings = list(
            ...
            .values("id", "owner__username", "crop__name", "market__name", "quantity", "unit", "price", "active")
        )
...
class TransportRequestStatusView(APIView):
    ...
    def patch(self, request, booking_id):
        ...
        if not request.user.is_staff and booking.farmer != request.user:
