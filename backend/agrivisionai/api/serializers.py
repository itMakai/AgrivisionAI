...
class ServiceProviderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'contact_name', 'contact_phone', 'email', 'address', 'verified',
    ...
    def get_services(self, obj):
        try:
            # ServiceSerializer is defined later in this module; resolve at runtime
...
class ListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Listing
        fields = [
            'id', 'owner', 'owner_description', 'owner_has_transport', 'owner_transport_capacity', 'owner_transport_unit',
