...
class ServiceProvider(models.Model):
    ...
    # Optional link to a platform user account (enables provider login + managing transport requests)
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='service_provider')
